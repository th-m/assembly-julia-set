...
2:
  fmuld	d4, d2, d2	@computes a^2
  fmuld	d5, d3, d3	@computes b^2
  faddd	d6, d4, d5	@computes a^2 + b^ 2
  fcmpd	d6, d7		@compares a^2 + b^2 >= 4.0
  ...
  cmp	r0, r1		@compares iterations with maxIterations
  bgt	4f		@exits the loop if iters >= maxiters

  fmuld	d3, d3, d2	@computes a * b
  faddd	d3, d3, d3	@computes 2ab
  faddd	d3, d3, d1	@computes b = 2ab + y and stores it as the new b

  fsubd	d2, d4, d5	@computes a^2 - b^2
  faddd	d2, d2, d0	@computes a^2 - b^2 + x and stores it as the new A
